 ...
 */
function ajouterPublication(titre: string, auteur: string, date: string, contenu: string) {
    ...
    $("#confirmDialog").dialog({
        ...
        buttons: {
            ...
            "Confirmer": function() {
                ...
                var titre = $("#titre").val() as string;
                var auteur = $("#auteur").val() as string;
                var date = $("#date").val() as string;
                var contenu = $("#contenu").val() as string;
